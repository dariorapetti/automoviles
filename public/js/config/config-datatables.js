...
var datatables_default_options = {
    responsive: false,
    // DOM Layout settings
    dom: "B<'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>",
                ...
                switch (type) {
                    ...
                    case 'select':
                        ...
                        $.each(options, function (indexOption, valueOption) {
                            ...
                            $(input).append('<option ' + (optionData[0] === 'Todos' ? 'selected="selected"' : '') + 'value="' + optionData[0] + '">' + optionData[1] + '</option>');
                        });
